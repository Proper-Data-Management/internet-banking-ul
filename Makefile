...
# todo: добить тесты
SCRIPT_VERSION=v1.0
SCRIPT_AUTHOR=Alexandr (Alex M.A.K.) Mikhailenko

# pkg-config --cflags --libs oci8
LDFLAGS += -s -w -extldflags "-I/opt/oracle/instantclient_21_7/sdk/include -L/opt/oracle/instantclient_21_7/ -lclntsh" -X main.GitCommit=$(VERSION)
...
build: ## Build your project and put the output binary in out/bin/
	mkdir -p out/bin
	GO111MODULE=on $(GOCMD) build -ldflags '$(LDFLAGS)' -o out/bin/$(BINARY_NAME) .
